package com.epam.esm.authorization.integration.container;

import com.epam.esm.authorization.integration.constant.DatabaseProperties;
...
public class PostgreSqlTestContainer implements Extension, BeforeAllCallback, AfterAllCallback {
    ...
    private static final PostgreSQLContainer<?> postgreSQLContainer =
        new PostgreSQLContainer<>(DatabaseProperties.POSTGRES_IMAGE_VERSION)
